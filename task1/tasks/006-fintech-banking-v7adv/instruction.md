...
```
account-overview.desktop.png  account-overview.tablet.png  account-overview.mobile.png
cards.desktop.png  cards.tablet.png  cards.mobile.png
statements.desktop.png  statements.tablet.png  statements.mobile.png
support.desktop.png  support.tablet.png  support.mobile.png
transactions.desktop.png  transactions.tablet.png  transactions.mobile.png
```
