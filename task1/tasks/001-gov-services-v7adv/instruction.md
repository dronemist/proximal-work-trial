...
```
account.desktop.png  account.tablet.png  account.mobile.png
application.desktop.png  application.tablet.png  application.mobile.png
appointments.desktop.png  appointments.tablet.png  appointments.mobile.png
notifications.desktop.png  notifications.tablet.png  notifications.mobile.png
service-catalog.desktop.png  service-catalog.tablet.png  service-catalog.mobile.png
```
