...
```
alerts.desktop.png  alerts.tablet.png  alerts.mobile.png
builds.desktop.png  builds.tablet.png  builds.mobile.png
deploys.desktop.png  deploys.tablet.png  deploys.mobile.png
projects.desktop.png  projects.tablet.png  projects.mobile.png
team.desktop.png  team.tablet.png  team.mobile.png
```
