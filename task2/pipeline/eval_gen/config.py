...
class GenConfig:
    ...
    # Animation settings
    animation_mode: str = "none"       # "none" = static (Part 1), "css" = Tier 1 CSS animations (Part 2)
    animation_complexity: str = "medium"  # "simple", "medium", "hard" — controls how many primitives sampled
    animation_keyframe_pcts: list[float] = field(default_factory=lambda: [0.0, 0.5, 1.0])  # progress points to capture
