...
- **`clip-reveal-up`** — entrance, ~511ms, animates: clipPath
- **`rotate-in`** — entrance, ~676ms, animates: opacity, transform (×23)
- **`shimmer`** — looping/ambient, ~2378ms, animates: backgroundPositionX, backgroundPositionY

Filmstrip references (in `/reference/filmstrips/`):

- `people-directory.desktop.filmstrip.png`
- `people-directory.tablet.filmstrip.png`
- `people-directory.mobile.filmstrip.png`
