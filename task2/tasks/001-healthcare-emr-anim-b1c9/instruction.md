...
- **`spin-slow`** — looping/ambient, ~2836ms, animates: transform
- **`fade-right`** — entrance, ~484ms, animates: opacity, transform (×2)
- **`fade-in`** — entrance, ~530ms, animates: opacity (×7)
- **`shimmer`** — looping/ambient, ~2088ms, animates: backgroundPositionX, backgroundPositionY (×3)

Filmstrip references (in `/reference/filmstrips/`):

- `patient-dashboard.desktop.filmstrip.png`
- `patient-dashboard.tablet.filmstrip.png`
- `patient-dashboard.mobile.filmstrip.png`

Video recordings of the animations (in `/reference/videos/`):

- `patient-dashboard.desktop.webm`
- `patient-dashboard.tablet.webm`
- `patient-dashboard.mobile.webm`
