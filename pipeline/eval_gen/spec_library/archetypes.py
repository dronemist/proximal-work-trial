...
ARCHETYPES: list[Archetype] = [
    ...
    {"name": "settings-form", "description": "Left in-page nav, right form rows with labels and inputs grouped into sections."},
    {"name": "pricing-tiers", "description": "Hero with tagline, then 3-4 tier cards side-by-side, feature comparison table below."},
    {"name": "feature-grid-landing", "description": "Hero, then 3x2 icon-headline-blurb grid, social proof strip, CTA footer."},
    {"name": "card-feed-masonry", "description": "Variable-height cards in 3-5 columns; Pinterest-style masonry."},
    {"name": "list-detail-split", "description": "Left list of items + right detail panel showing the selected item."},
    ...
    {"name": "auth-centered-card", "description": "Centered card on muted background: form fields, social auth buttons, divider."},
    ...
    {"name": "long-form-article", "description": "Centered single-column reading width (~720px), large headline, byline, scrolling body."},
